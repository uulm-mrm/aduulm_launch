...
class ConverterRos2Test(unittest.TestCase):
    def test_simple(self):
        ...
        self.assertEqual(ga_nodes[0].node_package, node_args['package_name'])
        self.assertEqual(ga_nodes[0].node_executable,
                         node_args['executable_name'])
    ...
    def test_include_ros(self):
        ...
        include_args: dict[str, Any] = dict(
            package_name='test_package', launch_filename='test_launch')
    ...
    def test_execute_process(self):
        config = LaunchConfig()
        proc_args: dict[str, Any] = dict(executable_name='test_executable')
