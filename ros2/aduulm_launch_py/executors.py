...
def execute(gen_config: Callable[Concatenate[LaunchConfig, P], None], _exit=True, _debug=False, _extra_ros2_modules: List[LaunchDescriptionEntity] = [], *args: P.args, **kwargs: P.kwargs):
    config = LaunchConfig()
    config.parse_argv()
